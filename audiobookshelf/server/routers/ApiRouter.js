...
const KokoroController = require('../controllers/KokoroController')
...
class ApiRouter {
  ...
  init() {
    //
    // Kokoro Integration Routes
    //
    this.router.get('/kokoro/aligners', KokoroController.listAligners.bind(this))
    this.router.get('/kokoro/books', KokoroController.listBooks.bind(this))
    this.router.get('/kokoro/books/:bookId', KokoroController.getBook.bind(this))
    this.router.get('/kokoro/books/:bookId/chapters/:chapterIndex/metadata', KokoroController.getChapterMetadata.bind(this))
    this.router.get('/kokoro/books/:bookId/chapters/:chapterIndex/audio', KokoroController.streamChapterAudio.bind(this))
    this.router.get('/kokoro/tasks/:taskId', KokoroController.getTask.bind(this))
    this.router.post('/kokoro/audiobooks', KokoroController.requireAdmin.bind(this), KokoroController.createAudiobook.bind(this))
    this.router.delete('/kokoro/books/:bookId', KokoroController.requireAdmin.bind(this), KokoroController.deleteBook.bind(this))
